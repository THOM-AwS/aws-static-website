...
STATIC_HEADERS_TO_ADD = {
    ...
    'content-security-policy': [{
        ...
        'value':
        "default-src 'self' data: *.googleapis.com https://www.google-analytics.com https://analytics.google.com;"
        "base-uri 'self';"
        ...
        "connect-src 'self' https://www.google-analytics.com https://maps.googleapis.com https://api.hamer.cloud;"
        "object-src 'none'"
    }],
