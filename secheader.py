    ...
    "content-security-policy": [
        {
            ...
            "value": (
                "default-src 'self' data: *.googleapis.com https://www.google-analytics.com https://analytics.google.com https://api.hamer.cloud/data https://*.hamer.cloud/fitbit https://*.datahub.io https://cdnjs.cloudflare.com; "
                "base-uri 'self'; "
