...
STATIC_HEADERS_TO_ADD = {
    ...
    'content-security-policy': [{
        ...
        "connect-src 'self' https://www.google-analytics.com https://maps.googleapis.com https://api.hamer.cloud https://analytics.google.com https://analytics.google.com https://api.openweathermap.org https://datahub.io/core/geo-countries/r/countries.geojson ;"
        "object-src 'none'"
    }],
