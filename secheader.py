...
STATIC_HEADERS_TO_ADD = {
    ...
    'content-security-policy': [{
        ...
        "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://maps.googleapis.com https://maps.gstatic.com https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js;"
