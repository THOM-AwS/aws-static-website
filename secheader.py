    ...
    "content-security-policy": [
        {
            ...
            "value": (
                ...
                "connect-src 'self' https://www.google-analytics.com https://maps.googleapis.com https://*.hamer.cloud https://analytics.google.com https://api.openweathermap.org https://datahub.io/core/geo-countries/r/countries.geojson https://datahub.io https://pkgstore.datahub.io/core/geo-countries/countries/archive/* https://cdn.jsdelivr.net https://api.github.com; "
                "object-src 'none'"
            ),
        }
    ],
