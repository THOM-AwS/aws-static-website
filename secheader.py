...
STATIC_HEADERS_TO_ADD = {
    ...
    'content-security-policy': [{
        ...
        "script-src 'self' 'unsafe-inline' 'unsafe-eval' *.googleapis.com https://maps.gstatic.com https://www.youtube.com *.google.com https://*.gstatic.com https://geoip-js.com data: blob:;"
